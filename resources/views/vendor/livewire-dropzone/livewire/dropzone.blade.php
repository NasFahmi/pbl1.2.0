        ...
        <div @click="$refs.input.click()"
            ...
            <div>
                <div x-show="!isDragging"
                    ...
                    <p class="dz-text-md dz-text-gray-600 ">Drop here or <span
                            class="dz-font-semibold dz-text-black ">Browse files</span></p>
                </div>
                <div x-show="isDragging"
            ...
            <input x-ref="input" wire:model="upload" type="file" class="dz-hidden"
                ...
                x-on:livewire-upload-error="console.log(error)"
