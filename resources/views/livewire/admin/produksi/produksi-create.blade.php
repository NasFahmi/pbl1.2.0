<div>
    <div class="container px-6 pb-6 mx-auto">
        <x-beardcumb menu='Produksi' submenu='create' routemenu='admin.produksi' />
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                        ...
                        <div class="max-w-lg">
                            <div class="flex justify-start items-start flex-col gap-3">
                                <div class="w-full">
                                    ...
                                    {{-- <p>{{ $produk }}</p> --}}
                                    <input type="text" placeholder="Produk" wire:model="produk"
                                        value="{{ old('produk') }}"
                                ...
                                <div class="w-full mt-4">
                                    ...
                                    {{-- <p>{{ $jumlah }}</p> --}}
                                    <input type="number" placeholder="Jumlah" wire:model="jumlah"
                                        value="{{ old('jumlah') }}"
                                        class="bg-gray-50 border max-w-4xl border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-2.5 " />
                                    @error('jumlah')
                                        <small class="error" style="color: red">{{ $message }}</small>
                    ...
                    <div class="right">
                        <div class="w-full">
                            ...
                            {{-- <p>{{ $volume }}</p> --}}
                            <input type="number" placeholder="Volume" wire:model="volume" value="{{ old('volume') }}"
                                class="bg-gray-50 border max-w-4xl border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-2.5 " />
                            @error('volume')
                                <small class="error" style="color: red">{{ $message }}</small>
                            @enderror
