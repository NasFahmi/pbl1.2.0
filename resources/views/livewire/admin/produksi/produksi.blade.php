                        ...
                        <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                            <svg class="w-5 h-5 text-gray-500" aria-hidden="true" viewBox="0 0 24 24" fill="none"
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    <path d="M12 19L12 11" stroke="#6b7280" stroke-width="4" stroke-linecap="round">
                                    </path>
                                    <path d="M7 19L7 15" stroke="#6b7280" stroke-width="4" stroke-linecap="round">
                                    </path>
                                        ...
                                        <ul class="text-sm text-gray-700 dark:text-gray-200 rounded-3xl"
                                            ...
                                            <li>
                                                @if (auth()->check() && auth()->user()->hasRole('superadmin'))
                                                    <a href="{{ route('admin.produksi.edit', $items->id) }}"
                                            ...
                                            <li>
                                                @if (auth()->check() && auth()->user()->hasRole('superadmin'))
                                                    <button onclick="deleteProduksi({{ $items->id }})"
        ...
        function deleteProduksi($id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Livewire.dispatch('deleteProduksi', {
                        idProduksi: $id
                    });
                }
            });
